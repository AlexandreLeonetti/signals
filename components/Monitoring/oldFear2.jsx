...
const FearGreed = ({ fng, text }) => {
	...
	return (
		<div className={` flex flex-col items-center space-y-10 p-24`}>
			<h2 className="text-xl font-medium">Fear and Greed Indicator</h2>
			<div className="w-full h-full p-20  bg-[#454547] text-white  flex justify-center items-center rounded-md shadow-md">
				<div className="w-full h-full">
					<div
						...
						className="absolute top-[81px] left-[-5px] h-5 w-5  rounded-full bg-gray-700 border-2 border-white"
					/>
